...
export default function HeroSection() {
  ...
  const fullText = "AI/ML Research Engineer";
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <svg width="100%" height="100%" viewBox="0 0 1200 800" className="w-full h-full">
          <defs>
            <radialGradient id="nodeGradient">
              <stop offset="0%" stopColor="hsl(191, 100%, 50%)" stopOpacity="0.8"/>
              <stop offset="100%" stopColor="hsl(191, 100%, 50%)" stopOpacity="0.2"/>
            </radialGradient>
          </defs>
          <line x1="100" y1="100" x2="300" y2="200" stroke="hsl(191, 100%, 50%)" strokeWidth="1" opacity="0.3"/>
          <line x1="300" y1="200" x2="500" y2="150" stroke="hsl(258, 84%, 65%)" strokeWidth="1" opacity="0.3"/>
          <line x1="500" y1="150" x2="700" y2="300" stroke="hsl(148, 100%, 50%)" strokeWidth="1" opacity="0.3"/>
          <line x1="700" y1="300" x2="900" y2="200" stroke="hsl(191, 100%, 50%)" strokeWidth="1" opacity="0.3"/>
          <circle cx="100" cy="100" r="3" fill="url(#nodeGradient)"/>
          <circle cx="300" cy="200" r="3" fill="url(#nodeGradient)"/>
          <circle cx="500" cy="150" r="3" fill="url(#nodeGradient)"/>
          <circle cx="700" cy="300" r="3" fill="url(#nodeGradient)"/>
          <circle cx="900" cy="200" r="3" fill="url(#nodeGradient)"/>
        </svg>
      </div>
      
      {/* Floating Orbs */}
      <div className="floating-orb w-20 h-20 top-20 left-20 animate-float" style={{animationDelay: '0s'}}></div>
      <div className="floating-orb w-12 h-12 top-40 right-32 animate-float" style={{animationDelay: '2s'}}></div>
      <div className="floating-orb w-16 h-16 bottom-32 left-1/4 animate-float" style={{animationDelay: '4s'}}></div>
      ...
      <div className="text-center z-10 max-w-4xl mx-auto px-4">
        ...
        <div className={`font-inter text-xl md:text-2xl mb-6 text-gray-300 ${isTyping ? 'typing-animation' : ''}`}>
          {typedText}
        </div>
